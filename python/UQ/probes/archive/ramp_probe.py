"""Same s1.0 flow member with the production mask floor and a 6000-iteration
injection force ramp: does a steady injected state exist when the transient
approaches it gradually?"""
import os
import sys
import time
